...
```gradle
dependencies {
    implementation 'com.github.apiverve:solarpotential-api:1.1.12'
}
```
...
```java
import com.apiverve.solarpotential.SolarPotentialAPIClient;
import com.apiverve.solarpotential.APIResponse;
import com.apiverve.solarpotential.APIException;

// Initialize the client
SolarPotentialAPIClient client = new SolarPotentialAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/solarpotential](https://docs.apiverve.com/ref/solarpotential)
...
- **Documentation:** [https://docs.apiverve.com/ref/solarpotential](https://docs.apiverve.com/ref/solarpotential)
- **Issues:** [GitHub Issues](https://github.com/apiverve/solarpotential-api/issues)
