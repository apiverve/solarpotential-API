# Solar Potential API - Examples

This folder contains example code for using the Solar Potential API across different platforms.
...
response = requests.get('https://api.apiverve.com/v1/solarpotential',
  headers={'x-api-key': 'YOUR_API_KEY'})
data = response.json()
```
...
- **API Reference:** [https://docs.apiverve.com/ref/solarpotential](https://docs.apiverve.com/ref/solarpotential)
