...
setup(
    ...
    project_urls={
        ...
        'Documentation': 'https://docs.apiverve.com/ref/solarpotential',
        'Source': 'https://github.com/apiverve/solarpotential-api',
        'Bug Tracker': 'https://github.com/apiverve/solarpotential-api/issues'
    },
    classifiers=[
